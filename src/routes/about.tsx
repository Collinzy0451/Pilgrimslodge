...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Pilgrims Lodge — MBEFAC | Ekpoma, Edo State" },
      { name: "description", content: "Learn about Pilgrims Lodge and Maranatha Beauty For Ashes Club (MBEFAC) — our mission, vision and commitment to Christian growth." },
      { property: "og:title", content: "About Pilgrims Lodge & MBEFAC" },
    ],
  }),
  component: About,
});
  ...
  return (
    <Layout>
      <PageHero
        ...
        description={`Pilgrims Lodge is owned and operated by ${SITE.owner}. We exist for the spiritual formation of God's people.`}
      />
        ...
        <div className="container-prose grid gap-12 lg:grid-cols-[1.2fr,1fr]">
          <div className="space-y-6 text-base leading-relaxed text-foreground">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Pilgrims Lodge was established as a tangible expression of the heart of
            ...
            <div>
              ...
              <p className="mt-3 text-muted-foreground">
                ...
                The Lodge is one of the practical ministries through which MBEFAC serves
          ...
          <aside className="space-y-6">
            ...
            <blockquote className="rounded-2xl border border-border bg-muted/50 p-6 font-display text-lg italic">
              ...
              <footer className="mt-3 text-xs uppercase not-italic tracking-[0.2em] text-[color:var(--gold)]">Isaiah 61:3</footer>
            </blockquote>
          </aside>
        </div>
      </section>
