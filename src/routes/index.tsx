...
import roomImg from "@/assets/Hall1.jpeg";
import singleImg from "@/assets/room2.jpeg";
...
const featuredRooms = [
  { img: roomImg, name: "Standard Meeting Hall", desc: "Standard meeting hall for conferences and programmes." },
  { img: singleImg, name: "Standard Quiet Room", desc: "A still, simple room for solo retreat, journaling and personal communion." },
];
  ...
  return (
    <Layout>
        ...
        <div className="container-prose relative grid min-h-[88vh] place-items-center py-24 text-ivory">
          <div className="max-w-3xl fade-up">
            ...
            <h1 className="heading-display mt-5 text-4xl sm:text-6xl md:text-7xl">
              Be still, and know <span className="italic text-gold-soft">that He is God.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/retreats"
                className="inline-flex items-center gap-2 rounded-full bg-gold px-6 py-3 text-sm font-semibold text-deep shadow-(--shadow-gold) transition-transform hover:-translate-y-0.5"
              >
        ...
        <div className="container-prose grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex gap-4">
              <Link to="/about" className="text-sm font-semibold text-deep underline-offset-4 hover:underline">
                Our Story →
              </Link>
              <Link to="/facilities" className="text-sm font-semibold text-deep underline-offset-4 hover:underline">
                Our Facilities →
              </Link>
            </div>
          </div>
          <div className="relative">
            ...
            <img
              ...
              height={896}
              loading="lazy"
              className="rounded-2xl object-cover shadow-(--shadow-soft)"
            />
          </div>
        </div>
      </section>
      ...
      <section className="section-pad">
        <div className="container-prose">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <SectionHeader eyebrow="Accommodation" title="Featured facilities" />
            <Link to="/rooms" className="text-sm font-semibold text-deep underline-offset-4 hover:underline">
              View more rooms →
            </Link>
          </div>
          <div className="mt-10 grid gap-8 md:grid-cols-2">
            {featuredRooms.map((r) => (
              <article key={r.name} className="group overflow-hidden rounded-2xl border border-border bg-card shadow-(--shadow-soft)">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="container-prose relative py-24 text-center text-ivory">
          <Sparkles className="mx-auto h-7 w-7 text-gold-soft" />
          ...
          <p className="mt-4 text-sm uppercase tracking-[0.3em] text-gold-soft">— Psalm 23:2–3</p>
        </div>
      </section>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {events.map((e) => (
              <div key={e.title} className="rounded-2xl border border-border bg-card p-6">
                ...
                <Link to="/retreats" className="mt-4 inline-block text-sm font-semibold text-deep underline-offset-4 hover:underline">
                  Learn more →
                </Link>
              </div>
            ))}
      ...
      <section className="section-pad bg-muted/40">
        <div className="container-prose">
          ...
          <div className="mt-10 text-center">
            <Link to="/testimonials" className="inline-block rounded-full border border-border px-5 py-2 text-sm font-semibold text-foreground hover:border-gold">
      ...
      <section className="section-pad">
        <div className="container-prose">
          <div className="relative overflow-hidden rounded-3xl border border-border bg-deep p-10 text-ivory shadow-(--shadow-deep) sm:p-14">
            ...
            <div className="relative max-w-2xl">
              <p className="eyebrow text-gold-soft!">Plan your retreat</p>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link to="/reservations" className="rounded-full bg-gold px-6 py-3 text-sm font-semibold text-deep">
                  Reserve now
                </Link>
